...
async function runTests() {
  ...
  const winMgrCode = fs.readFileSync(path.join(__dirname, "../electron/windowManager.js"), "utf8");
  ...
  const browserPanelCode = fs.readFileSync(path.join(__dirname, "../src/renderer/components/BrowserPanel.jsx"), "utf8");
